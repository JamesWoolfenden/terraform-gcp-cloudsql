...
| <a name="input_mw_day"></a> [mw\_day](#input\_mw\_day) | Day of the week for the maintenance window (1 = Monday, 7 = Sunday). | `number` | `7` | no |
| <a name="input_mw_hour"></a> [mw\_hour](#input\_mw\_hour) | Hour of the day (UTC) for the maintenance window (0–23). | `number` | `6` | no |
...
| <a name="input_notification_channels"></a> [notification\_channels](#input\_notification\_channels) | Monitoring notification channel IDs to alert when the Cloud SQL instance's CPU utilization is critical. | `list(string)` | n/a | yes |
